...
// =============================================================================
// NOTE: Database-backed permission checking has been moved to auth-server.ts
// =============================================================================
// The database-backed functions are now in src/lib/auth-server.ts
// Import from there in server-side code (API routes, server components)
// This file (auth.ts) is safe to import in client-side code