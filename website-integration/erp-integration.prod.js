// ERP Integration Script - PRODUCTION VERSION
// Use this version when deploying your website to production
...
(function() {
  ...
  const CONFIG = {
    // Your ERP production URL (AWS ALB endpoint)
    ERP_API_URL: 'http://ots-erp-alb-1229912979.us-east-2.elb.amazonaws.com',

    // API Key - consider changing this in production and updating in both systems
  ...
  // (Copy the rest from erp-integration.js starting from line 15)
